Public Class Film_Theme_Quiz_Level_Menu
    ...
    Private Sub Film_Theme_Quiz_Level_Menu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        With Me
