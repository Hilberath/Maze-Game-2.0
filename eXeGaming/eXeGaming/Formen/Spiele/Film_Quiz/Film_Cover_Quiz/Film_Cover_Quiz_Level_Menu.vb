Public Class Film_Cover_Quiz_Level_Menu
    ...
    Private Sub Film_Cover_Quiz_Level_Menu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        With Me
